...
namespace Control_system
{
    ...
    {
        /*
        This it the class that encrypt a string into a AES 256 bit encryption.
        It needs a password for that the program knows how to encrypt the string.
        To encrypt you just call the function ecrypt(string,password) and vice versa for decryption
        */
        public encryption()
        {
        }
